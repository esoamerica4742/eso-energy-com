  ...
  return (
    ...
    >
      ...
      >
        ...
        {!sent ? (
          ...
          <div className="mt-6 sm:mt-7 space-y-4">
            ...
            <button
              ...
              className="w-full rounded-xl px-4 py-3 text-[12px] font-semibold tracking-[0.22em] uppercase hairline bg-[oklch(0.13_0.02_265_/_0.6)] text-silver hover:text-[oklch(0.85_0.16_165)] transition-colors"
            >
        ...
        <Link
          to="/login"
          className="mt-5 inline-flex items-center justify-center gap-1.5 w-full text-[11px] tracking-[0.22em] uppercase text-silver/70 hover:text-[oklch(0.85_0.16_165)] transition-colors"
        >
          <ArrowLeft className="h-3 w-3" />
          Back to sign in
        </Link>

        <div className="mt-7 sm:mt-8 pt-5 border-t border-[oklch(0.30_0.03_265_/_0.5)] flex items-center justify-between text-[10px] tracking-[0.22em] uppercase text-silver/60">
